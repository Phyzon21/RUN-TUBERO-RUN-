class playGame3 extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.image('bg_castle', 'assets/images/bg_castle.png');
    ...
    create(){
       world = 3;
        ...
        var bg_grass = this.add.image(512, 256, 'bg_castle');
  
        text2 = this.add.text(775, 50, highscore3, {
            fontSize: '40px',
            fill: '#ffffff' 
        });
        text = this.add.text(210, 50, score3, {
            fontSize: '40px',
            fill: '#ffffff' 
        });
    ...
    addPlatform(platformWidth, posX, posY){
        ...
        if(this.platformPool.getLength()){
            ...
            platform = this.add.tileSprite(posX, posY, platformWidth, 32, "platform3");
            this.physics.add.existing(platform);
            platform.body.setImmovable(true);
            platform.body.setVelocityX(Phaser.Math.Between(gameOptions3.platformSpeed[0], gameOptions3.platformSpeed[1]) * -1);
